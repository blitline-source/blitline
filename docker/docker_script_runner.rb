...
module Blitline
	class DockerScriptRunner
		...
		TEMP_BUCKET = "bltemp.shortlife"

		def initialize(src_file, script_text, output_file, uploader)
			@src_file = src_file
		...
		def run(src_path)
			src_url = uploader.simple_upload_to_s3(@src_file)
